											...
											<TBODY>
											  ...
											  <%--  <c:forEach items="${clist }" var="customer"> 
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer_getById.action&cust_id=${customer.cust_id}">修改</a>
													&nbsp;&nbsp;
											   ...
											   <s:iterator value="clist">
												<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer_getById.action&cust_id=">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/customer_delete.action&cust_id=">删除</a>
													</TD>
												</TR>
