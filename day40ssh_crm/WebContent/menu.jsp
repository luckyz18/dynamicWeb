								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="customer_initAddUI.action" 
														target=main>－ 新增客户</A></TD>
												</TR>
												<TR> 
													<TD class=menuSmall>
													<A class=style2 href="customer_findByPage" target=main>－ 客户列表</A></TD>
												</TR>
								...
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="linkman_initAdd.action"
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall><A class=style2 href="saleVisit_findByPage.action"
